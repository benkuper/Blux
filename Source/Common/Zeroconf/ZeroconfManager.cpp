...
void ZeroconfManager::showMenuAndGetService(StringRef searcherName, std::function<void(ServiceInfo*)> returnFunc, bool showLocal, bool showRemote, bool separateLocalAndRemote, bool excludeInternal)
{

...
public:
    ...
    void updateValuesFromComponent(Object* o, ObjectComponent* c) override;
    void updateValuesFromParameter(Object* o, ObjectComponent* c, Parameter * p, var value) override;

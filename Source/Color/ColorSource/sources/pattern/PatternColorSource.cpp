	...
	TimedColorSource(getTypeString(), params)
{
	...
	sourceColor = sourceParams.addColorParameter("Source Color", "The color to apply. The hue of this color may be modified by the speed and offset parameters.", Colours::red);
}
